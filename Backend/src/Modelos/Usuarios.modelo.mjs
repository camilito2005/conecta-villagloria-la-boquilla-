...
export async function ObtenerUsuarios() {
  const consulta = "SELECT u.id_usuario,u.nombre,u.email, u.contraseña,c.cargo AS descripcion_cargo,u.imagen_url,u.telefono,u.direccion,u.identificacion,u.estado FROM  public.usuarios u INNER JOIN public.cargo c ON u.id_cargo = c.id_cargo";
